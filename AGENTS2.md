...
- Dashboard content order (2026-09-18): operational sections (anchor KPIs, Parcel Volume, rider/parcel rail) render first; `PeakAlertBanner` and `ConnectionHistoryChart` are secondary diagnostics rendered after the canvas grid, not above it.
